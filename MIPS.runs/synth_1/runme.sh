...
HD_PWD='C:/Users/javic/Downloads/MIPS/MIPS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Impl_MIPS.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Impl_MIPS.tcl

...
HD_PWD='C:/Users/javic/Downloads/MIPS/MIPS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Impl_MIPS.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Impl_MIPS.tcl -notrace
